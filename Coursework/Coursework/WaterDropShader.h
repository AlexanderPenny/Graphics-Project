...
class WaterDropShader : public BaseShader
{
private:
...
public:
	...
	WaterDropShader(ID3D11Device* device, HWND hwnd);
	~WaterDropShader();
	...
	void setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& world, 
		...
		ID3D11ShaderResourceView* rainDrip, ID3D11ShaderResourceView* rainDripMask, float timer,
